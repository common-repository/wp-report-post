...
<div class="remodal" data-remodal-id="report-post" role="dialog" aria-labelledby="report-post-modal-title" aria-describedby="report-post-modal-desc">
    <a data-remodal-action="close" class="remodal-close" aria-label="<?php _e('Close', 'wp-report-post'); ?>"></a>
    <div>
...
<?php
    ...
    function admin_menu()
    {
        add_menu_page( __('Reported Posts', 'wp-report-post'), __('Reported Posts', 'wp-report-post'), 'edit_others_posts', 'wp-report-post', array($this, 'reported_posts'), 'dashicons-megaphone' );
        add_submenu_page('wp-report-post', __('Options', 'wp-report-post'), __('Options', 'wp-report-post'), 'edit_others_posts', 'wp-report-post-options', array($this, 'options_page'));
    }
...
<div class="wrap">
    ...
    <h2><?php _e('WP Report Post Options', 'wp-report-post'); ?></h2>
    <h2 class="wp-report-post-options-section"><?php _e('Integration', 'wp-report-post'); ?></h2>
    <table class="form-table wp-report-post-options-table">
        <tr>
            <th scope="row"><?php _e('Automatically add', 'wp-report-post'); ?></th>
            <td><?php $this->select('add_what', $this->defaults['add_what_options'], $this->get_option('add_what')); ?><span>&nbsp;&nbsp;<?php _e('(Select Nothing if you want to add link or button manually - in template file)', 'wp-report-post'); ?></span>
            </td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Add after element', 'wp-report-post'); ?></th>
            <td><?php $this->input('add_after', $this->get_option('add_after')); ?></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Message Min Length', 'wp-report-post'); ?></th>
            <td><?php $this->input('msg_min_length', $this->get_option('msg_min_length')); ?></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Date / Time format', 'wp-report-post'); ?></th>
            <td><?php $this->select('date_format', $this->defaults['date_format_options'], $this->get_option('date_format')); ?></td>
        </tr>
        <tr>
            <th scope="row">&nbsp;</th>
            <td><label for="require_login"><?php $this->checkbox('require_login', $this->get_option('require_login')); ?> <?php _e('Require user to be logged in to report', 'wp-report-post'); ?></label></td>
        </tr>
<?php
...
?>
    ...
    <h2 class="wp-report-post-options-section"><?php _e('Antispam', 'wp-report-post'); ?></h2>
    <table class="form-table wp-report-post-options-table">
        <tr>
            <th scope="row">&nbsp;</th>
            <td><label for="use_captcha"><?php $this->checkbox('use_captcha', $this->get_option('use_captcha')); ?> <?php _e('Use reCaptcha (you need both site-key and secret-key that you can obtain for free <a href="https://www.google.com/recaptcha/admin" target="_blank">here</a>)', 'wp-report-post'); ?></label></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('reCaptcha Site Key', 'wp-report-post'); ?></th>
        ...
        <tr>
            <th scope="row">&nbsp;</th>
            <td><label for="show_ip_to_client"><?php $this->checkbox('show_ip_to_client', $this->get_option('show_ip_to_client')); ?> <?php _e('Show IP to client that is reporting (otherwise to Admin only)', 'wp-report-post'); ?></label></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('IP Whois URL:', 'wp-report-post'); ?></th>
            <td><?php $this->input('whois_url', $this->get_option('whois_url')); ?></td>
        </tr>        
    </table>
    <h2 class="wp-report-post-options-section"><?php _e('Email Notification', 'wp-report-post'); ?></h2>
    <table class="form-table wp-report-post-options-table">
        <tr>
            <th scope="row">&nbsp;</th>
            <td><label for="require_login"><?php $this->checkbox('email_notification', $this->get_option('email_notification')); ?> <?php _e('Send email notification when somebody reports a post or page', 'wp-report-post'); ?></label></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Send Notification to', 'wp-report-post'); ?></th>
            <td><?php $this->input('email_address', $this->get_option('email_address')); ?></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Email Subject', 'wp-report-post'); ?></th>
            <td><?php $this->input('email_subject', $this->get_option('email_subject')); ?></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Email Body', 'wp-report-post'); ?></th>
            <td><?php $this->textarea('email_body', $this->get_option('email_body'), 8); ?>
                <p><b><?php _e('Variables:', 'wp-report-post'); ?> </b>[post_title], [post_id], [name], [email], [ip], [message], [date], [time], [permalink]</p>
            </td>
        </tr>
    </table>
    <h2 class="wp-report-post-options-section"><?php _e('Texts', 'wp-report-post'); ?></h2>
    <table class="form-table wp-report-post-options-table">
<?php
...
<?php
    ...
    <p class="submit">
    <input type="submit" class="button-primary" value="<?php _e('Save Options', 'wp-report-post'); ?>" />
    </p>
    </form>
</div>
    <?php
...
<br />
<a data-remodal-action="cancel" class="remodal-cancel"><?php _e('Cancel', 'wp-report-post'); ?></a>
<a id="remodal-confirm-submit" href="#" class="remodal-confirm"><?php _e('Confirm', 'wp-report-post'); ?></a>
</div>
<script>
...
jQuery(document).ready(function($)
{
    ...
    $('.remodal-confirm-link').click(function(e)
    {
        ...
        remodal_confirm(post_action+' <?php _e('Posts', 'wp-report-post'); ?>', '<?php _e('Are you sure you want to', 'wp-report-post'); ?> '+post_action+' <?php _e('the post titled', 'wp-report-post'); ?> &laquo;'+the_title+'&raquo;?', href);
        e.preventDefault();
    });
...
<?php
    ...
    function __construct()
    {
        ...
        (
            ...
            'email_address'         => '',
            'email_subject'         => __('[WP Report Post] Somebody reported a post!', 'wp-report-post'),
            ...
            'recaptcha_secret'      => '',
            'date_format'           => 'human',
            'date_format_options'   => array('human' => __('Human (e.g 5 minutes ago)', 'wp-report-post'), 'date' => __('Date / Time', 'wp-report-post')),
            'require_login'         => '0',
            'add_what_options'      => array(''=>__('Nothing', 'wp-report-post'), 'link'=>__('Link', 'wp-report-post'), 'button'=>__('Button', 'wp-report-post')),
            'add_what_option'       => 'link',
            'add_after_option'      => 'span.byline',
            'text_report_post'      => __('Report Post', 'wp-report-post'),
            'text_report_link'      => __('Report Post', 'wp-report-post'),
            'text_your_name'        => __('Your Name:', 'wp-report-post'),
            'text_your_email'       => __('Your Email:', 'wp-report-post'),
            'text_your_msg'         => __('Please tell us why do you think this post is inappropriate and shouldn\'t be there:', 'wp-report-post'),
            'text_cancel'           => __('Cancel', 'wp-report-post'),
            'text_submit'           => __('Report', 'wp-report-post'),
            'text_post_doesnt_exist'=> __('Specified Post does not exist', 'wp-report-post'),
            'text_email_invalid'    => __('Please provide a valid email address', 'wp-report-post'),
            'text_name_invalid'     => __('Please enter your name', 'wp-report-post'),
            'text_msg_invalid'      => __('Please describe why do you think this post is inappropriate', 'wp-report-post'),
            'text_already_reported' => __('You have already reported this post', 'wp-report-post'),
            'text_success'          => __('You have successfully reported inappropriate post', 'wp-report-post'),
            'text_error'            => __('Error submitting report', 'wp-report-post'),
            'text_require_login'    => __('Please <a href="%s">log in</a> to report posts', 'wp-report-post'),
            'text_verification_code'=> __('Verification Code:', 'wp-report-post'),
            'text_your_ip'          => __('Your IP:', 'wp-report-post'),
            'text_captcha_invalid'  => __('Invalid verification code', 'wp-report-post') 
        );
        $this->text_options = array
        (
            'text_report_link'      => __('Link Text', 'wp-report-post'),
            'text_report_post'      => __('Modal Form Title', 'wp-report-post'),
            'text_your_name'        => __('Your Name:', 'wp-report-post'),
            'text_your_email'       => __('Your Email:', 'wp-report-post'),
            'text_your_msg'         => __('Your Message:', 'wp-report-post'),
            'text_cancel'           => __('Cancel button', 'wp-report-post'),
            'text_submit'           => __('Submit button', 'wp-report-post'),
            'text_post_doesnt_exist'=> __('Invalid Post', 'wp-report-post'),
            'text_email_invalid'    => __('Invalid Email', 'wp-report-post'),
            'text_name_invalid'     => __('Invalid Name', 'wp-report-post'),
            'text_msg_invalid'      => __('Invalid Message', 'wp-report-post'),
            'text_already_reported' => __('Already reported', 'wp-report-post'),
            'text_success'          => __('Successfully reported', 'wp-report-post'),
            'text_error'            => __('Error reporting', 'wp-report-post'),
            'text_verification_code'=> __('Text for Captcha', 'wp-report-post'),
            'text_your_ip'          => __('Your IP: text', 'wp-report-post'),
            'text_captcha_invalid'  => __('Invalid Captcha', 'wp-report-post')
        );
...
class WP_Report_Post_List extends WP_List_Table
{
    ...
    function time_elapsed_string($ptime)
    {
        ...
        $a = array
        (
            365 * 24 * 60 * 60  =>  __('year', 'wp-report-post'),
             30 * 24 * 60 * 60  =>  __('month', 'wp-report-post'),
                  24 * 60 * 60  =>  __('day', 'wp-report-post'),
                       60 * 60  =>  __('hour', 'wp-report-post'),
                            60  =>  __('minute', 'wp-report-post'),
                             1  =>  __('second', 'wp-report-post')
        );
        $a_plural = array
        (
            __('year', 'wp-report-post')   => __('years', 'wp-report-post'),
            __('month', 'wp-report-post')  => __('months', 'wp-report-post'),
            __('day', 'wp-report-post')    => __('days', 'wp-report-post'),
            __('hour', 'wp-report-post')   => __('hours', 'wp-report-post'),
            __('minute', 'wp-report-post') => __('minutes', 'wp-report-post'),
            __('second', 'wp-report-post') => __('seconds', 'wp-report-post')
        );
        foreach ($a as $secs => $str)
        {
            ...
            {
                $r = round($d);
                return $r . ' ' . ($r > 1 ? $a_plural[$str] : $str) . __(' ago', 'wp-report-post');
            }
        }
    }
    //
    ...
    function format_reports($reports)
    {
        ...
        if (is_array($rep))
        {
            ...
            foreach ($rep as $row)
            {
                $html .= '<a href="#" title="'. __('Click to view report', 'wp-report-post'). '" class="report-user-row">'. esc_html($row['name']). ' &lt;'. esc_html($row['email']). '&gt;</a> ('. $this->format_timestamp($row['timestamp']). ')';
                if ($row['user_ip'])
                {
                    $whois = str_replace('[ip]', urlencode($row['user_ip']), $this->options['whois_url']);
                    $html .= ' <a href="'. $whois. '" target="_blank">'. esc_html($row['user_ip']). '</a>';
                }
                $html .= '<br /><div class="report-user-hidden">'. esc_html($row['msg']);
                $html .= ' <a href="#" class="report-user-hide-link">'. __('Hide', 'wp-report-post'). '</a>';
                $html .= '</div>';
            }
            return $html;
        }
        ...
        {
            return __('Error', 'wp-report-post');
        }
    }
    //
    ...
    function get_columns()
    {
        $columns = array(
            ...
            'post_title' => __('Post Title', 'wp-report-post'),
            'post_date'  => __('Post Date', 'wp-report-post'),
            'post_author'=> __('Post Author', 'wp-report-post'),
            'post_status'=> __('Post Status', 'wp-report-post'),
            'meta_value' => __('Reports', 'wp-report-post')
        );
        return $columns;
    }
    //
    ...
    {
        $actions = array(
            'delete'    => __('Delete', 'wp-report-post'),
            'unpublish' => __('Unpublish', 'wp-report-post'),
            'publish'   => __('Publish', 'wp-report-post'),
            'delete_rep'=> __('Delete Reports', 'wp-report-post')
        );
        return $actions;
    }
    //
